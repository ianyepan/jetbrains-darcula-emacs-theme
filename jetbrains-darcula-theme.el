...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-level-1                              ((,class (:bold nil :foreground ,jb-bluegreen :height 1.1))))
   `(org-level-2                              ((,class (:bold nil :foreground ,jb-lightblue))))
   `(org-level-3                              ((,class (:bold nil :foreground ,jb-blue))))
